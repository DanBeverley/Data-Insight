...
class TestTrainingDecisionEngine:
    ...
    def test_small_dataset_routes_to_cpu(self, decision_engine):
        ...
        decision = decision_engine.decide(dataset_rows=100, feature_count=5, model_type="linear_regression", code=None)
    ...
    def test_large_dataset_routes_to_gpu(self, decision_engine):
        ...
        decision = decision_engine.decide(dataset_rows=100000, feature_count=100, model_type="deep_learning", code=None)
    ...
    def test_deep_learning_prefers_gpu(self, decision_engine):
        ...
        decision = decision_engine.decide(dataset_rows=5000, feature_count=20, model_type="deep_learning", code=None)
    ...
    def test_medium_dataset_cpu_default(self, decision_engine):
        ...
        decision = decision_engine.decide(dataset_rows=5000, feature_count=10, model_type="random_forest", code=None)
    ...
    def test_feature_count_impacts_decision(self, decision_engine):
        ...
        small_features = decision_engine.decide(dataset_rows=10000, feature_count=5, model_type="xgboost", code=None)

        many_features = decision_engine.decide(dataset_rows=10000, feature_count=500, model_type="xgboost", code=None)

        if small_features.environment == "cpu" and many_features.environment == "gpu":
            assert (
                many_features.confidence >= small_features.confidence
    ...
    def test_decision_object_structure(self, decision_engine):
        ...
        decision = decision_engine.decide(
            dataset_rows=1000, feature_count=10, model_type="linear_regression", code=None
        )
...
class TestGPUEnvironmentDetection:
    ...
    def test_cpu_fallback_always_available(self):
        ...
        try:
            ...
            decision = engine.decide(dataset_rows=1000, feature_count=10, model_type="linear_regression", code=None)

            assert decision.environment in ["cpu", "gpu"], "Should always have a valid environment decision"
        except ImportError:
            pytest.skip("Training decision engine not available")
