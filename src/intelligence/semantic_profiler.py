...
class SemanticColumnProfiler:
    def __init__(self):
        ...
        self.identifier_patterns = [r"id", r"key", r"index", r"number", r"code", r"ref"]
    ...
    ) -> List[Tuple[TaskRecommendation, float]]:
        recommendations = []
    ...
    def _recommend_targets(
        self, profiles: Dict[str, ColumnProfile], task_recommendations: List[Tuple[TaskRecommendation, float]]
    ) -> List[Tuple[str, TaskRecommendation, float]]:
        recommendations = []
