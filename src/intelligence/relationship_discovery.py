...
class RelationshipDiscovery:
    ...
    def discover_relationships(self, df: pd.DataFrame, column_profiles: Optional[Dict] = None) -> List[Relationship]:
    ...
    def _detect_key_relationships(self, df: pd.DataFrame, column_profiles: Optional[Dict] = None) -> List[Relationship]:
    ...
    def _detect_numerical_correlation(
        self, df: pd.DataFrame, column_profiles: Optional[Dict] = None
    ) -> List[Relationship]:
    ...
    def _detect_categorical_association(
        self, df: pd.DataFrame, column_profiles: Optional[Dict] = None
    ) -> List[Relationship]:
    ...
    def _detect_numerical_categorical(
        self, df: pd.DataFrame, column_profiles: Optional[Dict] = None
    ) -> List[Relationship]:
    ...
    def _detect_temporal_dependency(
        self, df: pd.DataFrame, column_profiles: Optional[Dict] = None
    ) -> List[Relationship]:
    ...
    def _detect_functional_dependency(
        self, df: pd.DataFrame, column_profiles: Optional[Dict] = None
    ) -> List[Relationship]:
    ...
    def _detect_hierarchical_relationship(
        self, df: pd.DataFrame, column_profiles: Optional[Dict] = None
    ) -> List[Relationship]:
