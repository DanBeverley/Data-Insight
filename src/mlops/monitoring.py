...
class PerformanceMonitor:
    ...
    def _trigger_alert(self, deployment_id: str, metric_type: MetricType, 
                      severity: AlertSeverity, current_value: float, threshold_value: float):
    ...
    def get_metrics(self, deployment_id: str, metric_type: Optional[MetricType] = None,
                   hours_back: int = 24) -> Dict[str, List[MetricPoint]]:
    ...
    def get_alerts(self, deployment_id: Optional[str] = None, 
                  severity: Optional[AlertSeverity] = None,
                  hours_back: int = 24) -> List[Alert]:
...
class RetrainingTrigger:
    def __init__(self, monitor: PerformanceMonitor):
        ...
        self.trigger_conditions = {
            MetricType.ACCURACY: lambda x: x < 0.7,
            MetricType.ERROR_RATE: lambda x: x > 0.1
        }
