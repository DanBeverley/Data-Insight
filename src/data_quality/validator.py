...
class DataQualityValidator:
    ...
    def _check_for_duplicates(self) -> ValidationCheck:
        ...
        return ValidationCheck(name="Duplicate Row Check", passed=True, message="No duplicate rows found.")
    ...
    def _check_schema_compliance(self) -> ValidationCheck:
        ...
        if not self.expected_schema:
            return ValidationCheck(
                name="Schema Compliance Check", passed=True, message="No expected schema provided; skipping validation."
            )
        ...
        if missing_cols or extra_cols:
            ...
            return ValidationCheck(
                name="Schema Compliance Check", passed=False, message=f"Schema mismatch detected.", details=details
            )
    ...
    def _check_outliers(self) -> ValidationCheck:
        ...
        return ValidationCheck(
            name="Outlier Detection Check", passed=True, message="No significant outliers detected in numeric columns."
        )
