...
class NarrativeGenerator:
    ...
    def generate_executive_summary(self,
                                 ...
                                 stakeholder_views: Dict[str, StakeholderView]) -> ExecutiveSummary:
        ...
        primary_metric = next((m for m in business_metrics if m.is_primary), business_metrics[0] if business_metrics else None)
        ...
        strategic_recommendations = self._distill_strategic_recommendations(
            validation_summary.strategic_recommendations,
            executive_view
        )
    ...
    def generate_technical_report(self,
                                ...
                                model_metadata: Optional[Dict[str, Any]] = None) -> TechnicalReport:
    ...
    def generate_custom_narrative(self,
                                project_definition: ProjectDefinition,
                                validation_summary: ValidationSummary,
                                business_metrics: List[BusinessMetric],
                                target_audience: str,
                                ...
                                length_target: str = "medium") -> NarrativeComponents:
        ...
        for section in sections:
            if section == ReportSection.EXECUTIVE_SUMMARY:
                ...
                components['recommendations'] = self._generate_section_recommendations(
                    validation_summary, tone
                )
    ...
    def _generate_project_overview(self, project_definition: ProjectDefinition, validation_summary: ValidationSummary) -> str:
    ...
    def _extract_key_achievements(self, validation_summary: ValidationSummary, 
                                business_metrics: List[BusinessMetric], 
                                executive_view: Optional[StakeholderView]) -> List[str]:
        ...
        if high_impact_metrics:
            achievements.append(f"Delivered high business impact across {len(high_impact_metrics)} key performance areas")
    ...
    def _generate_business_impact_narrative(self, business_metrics: List[BusinessMetric], domain: Domain) -> str:
        ...
        high_impact_count = len([m for m in business_metrics if m.business_impact and "high" in m.business_impact.lower()])
        ...
        if high_impact_count > 0:
            impact_narrative += f"Particularly noteworthy: {high_impact_count} metrics demonstrate high strategic impact. "
    ...
    def _distill_strategic_recommendations(self, raw_recommendations: List[str], 
                                         executive_view: Optional[StakeholderView]) -> List[str]:
        ...
        for rec in raw_recommendations:
            if any(keyword in rec.lower() for keyword in ['strategic', 'business', 'deployment', 'investment', 'scaling']):
    ...
    def _generate_investment_justification(self, business_metrics: List[BusinessMetric], 
                                         validation_summary: ValidationSummary, 
                                         project_definition: ProjectDefinition) -> str:
    ...
    def _generate_executive_next_steps(self, validation_summary: ValidationSummary, 
                                     project_definition: ProjectDefinition) -> List[str]:
    ...
    def _generate_methodology_narrative(self, project_definition: ProjectDefinition, 
    ...
    def _generate_performance_analysis(self, validation_summary: ValidationSummary, 
                                     business_metrics: List[BusinessMetric]) -> str:
    ...
    def _extract_technical_achievements(self, validation_summary: ValidationSummary, 
                                      technical_view: Optional[StakeholderView]) -> List[str]:
    ...
    def _extract_architecture_decisions(self, model_metadata: Optional[Dict[str, Any]], 
                                      project_definition: ProjectDefinition) -> List[str]:
    ...
    def _filter_technical_risks(self, risk_assessments: List[str]) -> List[str]:
        ...
        return [
            ...
            if any(keyword in risk.lower() for keyword in technical_keywords)
        ]
    ...
    def _generate_deployment_considerations(self, project_definition: ProjectDefinition,
                                          validation_summary: ValidationSummary,
    ...
    def _generate_section_executive_summary(self, project_definition: ProjectDefinition,
                                           validation_summary: ValidationSummary,
                                           business_metrics: List[BusinessMetric],
                                           tone: ReportTone) -> str:
    ...
    def _generate_section_technical_overview(self, project_definition: ProjectDefinition,
                                            validation_summary: ValidationSummary,
                                            tone: ReportTone) -> str:
    ...
    def _generate_section_business_impact(self, business_metrics: List[BusinessMetric],
                                        domain: Domain, tone: ReportTone) -> str:
    ...
    def _generate_section_performance_metrics(self, business_metrics: List[BusinessMetric],
                                            validation_summary: ValidationSummary,
                                            tone: ReportTone) -> str:
    ...
    def _generate_section_compliance_status(self, project_definition: ProjectDefinition,
                                          validation_summary: ValidationSummary,
                                          tone: ReportTone) -> str:
        ...
        if project_definition.domain in [Domain.FINANCE, Domain.HEALTHCARE]:
            ...
            return f"Compliance validation shows {compliance_rate:.0%} adherence to operational and ethical AI standards."
    
    def _synthesize_narrative_components(self, components: Dict[str, str], 
                                       length_target: str, tone: ReportTone) -> NarrativeComponents:
        ...
        recommendations = components.get('recommendations', '') or "Recommendations focus on value optimization and risk management."
