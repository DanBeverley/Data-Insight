...
class GraphSchema:
    ...
    def get_relationship_constraints(self) -> Dict[RelationshipType, Dict[str, List[NodeType]]]:
        ...
        return {
            RelationshipType.HAS_COLUMN: {"source": [NodeType.DATASET], "target": [NodeType.COLUMN]},
            RelationshipType.GENERATES_FEATURE: {"source": [NodeType.COLUMN], "target": [NodeType.FEATURE]},
            RelationshipType.DERIVED_FROM: {
                "source": [NodeType.FEATURE],
                "target": [NodeType.COLUMN, NodeType.FEATURE],
            },
            RelationshipType.TRAINED_ON: {"source": [NodeType.MODEL], "target": [NodeType.FEATURE, NodeType.DATASET]},
            RelationshipType.APPLIES_TO: {"source": [NodeType.MODEL, NodeType.PIPELINE], "target": [NodeType.PROJECT]},
            RelationshipType.ACHIEVES: {"source": [NodeType.PROJECT], "target": [NodeType.BUSINESS_OBJECTIVE]},
            RelationshipType.EVALUATED_BY: {"source": [NodeType.PROJECT, NodeType.MODEL], "target": [NodeType.USER]},
            RelationshipType.EXECUTED_BY: {"source": [NodeType.EXECUTION], "target": [NodeType.USER]},
            RelationshipType.HAS_EXECUTION: {"source": [NodeType.PROJECT], "target": [NodeType.EXECUTION]},
            RelationshipType.USES_PIPELINE: {"source": [NodeType.EXECUTION], "target": [NodeType.PIPELINE]},
        }
